...
export default function MarketLegend({ showLegend, setShowLegend }: MarketLegendProps) {
  return (
    <div
    ...
    >
      <Card className="w-80 shadow-lg border-gray-200 bg-white/95 backdrop-blur-sm">
        <CardHeader className="pb-3 flex flex-row items-center justify-between space-y-0">
          <div>
            <CardTitle className="text-base text-gray-800">สถานะแปลง</CardTitle>
            <p className="text-sm text-gray-500">Market Status Information</p>
          </div>
          <Button
            variant="ghost"
            size="sm"
